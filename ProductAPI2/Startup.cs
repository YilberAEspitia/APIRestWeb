...
namespace ProductAPI2
{
    public class Startup
    {
        ...
        {
            services.AddDbContext<ApplicationDBContext>(option => option.UseSqlServer(Configuration.GetConnectionString("DefaultConetionstring")));
